      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-white max-w-2xl mx-auto">
            We are passionate about sustainability, technology, and innovation.
            Our mission is to make waste classification smarter and easier for
            everyone.
          </p>
        </div>
            ...
            <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
              <div className="items-center rounded-lg shadow sm:flex dark:border-gray-700">
                ...
                <div className="p-5">
                  ...
                  <p className="mt-3 mb-4 font-light text-white dark:text-gray-400">
              ...
              <div className="items-center rounded-lg shadow sm:flex dark:border-gray-700">
                ...
                <div className="p-5">
                  ...
                  <span className="text-white dark:text-gray-400">CTO</span>
                  <p className="mt-3 mb-4 font-light text-white dark:text-gray-400">
